    ...
    if request.method == 'POST':
        try:
            ...
            data = {
                ...
                'statut': 'En cours',
                'listesetspecifications_prevu': None,
                'dossiers_appel_prevu': None,
                'date_lancement_prevu': None,
                'date_ouverture_prevu': None,
                'rapport_evaluation_prevu': None,
                'date_signature_prevu': None,
                'date_livraison_prevu': None,
                'listesetspecifications_reel': None,
                'dossiers_appel_reel': None,
                'date_lancement_reel': None,
                'date_ouverture_reel': None,
                'rapport_evaluation_reel': None,
                'date_signature_reel': None,
                'date_livraison_reel': None,
            }
            ...
            if getattr(travaux, "statut", None) != "Arrêté":
                dates_prevues = {
                    "listesetspecifications_prevu": travaux.listesetspecifications_prevu,
                ...
                dates_reels = {
                    "listesetspecifications_reel": travaux.listesetspecifications_reel,
                ...
                if computed and computed != "Données insuffisantes" and computed != travaux.statut:
                    travaux.statut = computed
                    travaux.save(update_fields=["statut"])
