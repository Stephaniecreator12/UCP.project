...
urlpatterns = [
    ...
    path('api/Biens/updateBiens/<int:id>/', BiensService.update_biens, name='api_update_biens'),
    ...
    path('api/Consultance/updateConsultance/<int:id>/', ConsultanceService.update_consultance, name='api_update_consultance'),
