...
ROOT_URLCONF = 'marches.controller.urls'
...
WSGI_APPLICATION = 'marches.controller.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ppm_app_db', # Le nom créé dans Laragon
        'USER': 'postgres',               # Par défaut dans Laragon
        'PASSWORD': 'iloveme',               # Vide par défaut dans Laragon
        'HOST': '127.0.0.1',
        'PORT': '5432',
    }
}
