    ...
    if request.method == 'POST':
        try:
            ...
            data = {
                ...
                'TdR_prevu': None, 
                'ami_prevu': None,
                'liste_restreinte_prevu': None,
                'demande_proposition_prevu': None,
                'date_invitation_prevu': None,
                'date_ouverture_prevu': None,
                'evaluation_technique_prevu': None,
                'ouverture_plis_prevu': None,
                'projet_contrat_prevu': None,
                ...
                'evaluation_technique_reel': None,
...
def calculer_planning_consultance(request):
    try:
        ...
        dates = {
            ...
            'evaluation_technique_prevu': (tdr + timedelta(days=rapp_off)).strftime('%Y-%m-%d'),
