      ...
      <CardContent className="space-y-6">
        <div className="flex flex-col gap-4">
          <label
            ...
            className="inline-flex w-fit cursor-pointer items-center rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100"
          >
