...
export default function SidebarMenu({
  ...
  return (
<aside 
  className="h-[calc(100vh-15px)] w-[200px] flex flex-col border border-[#d9dee3] rounded-[14px] bg-white shadow-[0_18px_36px_-30px_rgba(34,44,52,0.5)] p-4 max-[1150px]:static"
