          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Saisir l'email reçu dans le mail"
              />
            </div>
            <div>
              <label className="mb-2 block text-sm font-bold text-slate-700">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Saisir le code ou mot de passe reçu"
                />
                <button
                  type="button"
            ...
            >
              {loading ? "Vérification..." : "Accéder aux offres"}
            </button>
          </form>
